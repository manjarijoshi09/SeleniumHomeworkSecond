...
public class TestSuit{
    ...
    public static void VerifyUserShouldBeAbleToReferProductToFriend() {
        clickOnElement(By.className("ico-register"));
        //type first name
        typeText(By.id("FirstName"), "Keyur");
        //type last name
        typeText(By.id("LastName"), "Patel");
        //type email address
        typeText(By.name("Email"), "kp123@gmail.com");
        //type password
        typeText(By.id("Password"), "kp1234");
        //type confirm password
        typeText(By.id("ConfirmPassword"), "kp1234");
        //click on register submit button
        clickOnElement(By.id("register-button"));
       ...
       // clickOnElement(By.xpath("//a[@ href=\"/apple-macbook-pro-13-inch\"]"));
        ...
        clickOnElement(By.className("email-a-friend"));
        //Enter friend email
        typeText(By.className("friend-email"), "rohit123@gmail.com");
        //type the msg
        typeText(By.id("PersonalMessage"), "Kindly check product");
        //click on send email button
        clickOnElement(By.name("send-email"));
        String actualMessage = getTextFromElement(By.xpath("//div[@class='result']"));
        System.out.println("My Message:" + actualMessage);
    ...
    public static void VerifyUserShouldBeAbleTOVote() {
        ...
        System.out.println("My Message:" + actualMessage);
        // Expected message
        //Assert.assertEquals(actualMessage, expectedAbleToVoteMessage, "Votes are wrong");
        Assert.assertEquals(actualMessage, expectedAbleToVoteMessage, "Votes are wrong");
    }
    ...
    public static void VerifyUserShouldBeAbleToCompareProduct() {
        ...
        Assert.assertEquals(actualMessage2, expectedCompareProductMessage, "Can't compare product");
    }
}